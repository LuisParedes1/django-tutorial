...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        ...
        future_question = Question(question="",publication_date=future_time)
...
def create_question(question, days):
    ...
    return Question.objects.create(question=question, publication_date=time)
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        """
        question1 = create_question(question="Past question 1.", days=-30)
        question2 = create_question(question="Past question 2.", days=-5)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
            [question2, question1],
